    ...
    <div className="sm:px-4 md:px-6 lg:px-8 w-full">
      <div>
        <h1 className="text-[20px] font-[600] leading-[27.24px]">
          Where should the driver deliver the item(s)?
      ...
      <div>
        <div className="mt-[25px]">
          <h1 className="font-[700] text-[18px] leading-[21.6px]">
            Which item should the driver deliver at this delivery location?{" "}
            <span className="text-[#CF2D39]">*</span>
          </h1>
          <h2 className="font-[400] text-[14px] leading-[18.9px] text-black/50 mt-[12px]">
            Select the items you added before that you want the driver to
            deliver at this location
          </h2>
        </div>
      </div>
      <div>
      ...
      <div>
        <div>
          <h1 className="font-[600] text-[20px] leading-[24px] mt-[30px]">
            What does the driver need to know for delivery?
          </h1>
        </div>
        <div className="font-[400] text-[18px] leading-[24.3px] text-black/50 mt-[10px]">
          <h2>
            This instructions will be available to the driver only during
            delivery
          </h2>
        </div>
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            <p className="font-[400] text-[14px] leading-[16.8px] mt-[30px]">
